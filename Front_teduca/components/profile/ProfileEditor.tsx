...
export function ProfileEditor() {
  ...
  useEffect(() => {
    getMyProfile()
      .then((p) => {
        setProfile(p)
        getCoursesByTeacher(p.id).then(setCourses).catch(() => {})
      })
      .catch(() => setError(true))
  ...
  if (error || !profile) {
    return (
      <EmptyState
        ...
        description="El editor avanzado está disponible para perfiles de profesor. Tu identidad académica de estudiante se edita desde el onboarding."
      />
    )
  }
